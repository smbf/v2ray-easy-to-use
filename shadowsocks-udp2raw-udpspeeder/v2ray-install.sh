...
function install_v2ray(){
    ...
    bash <(curl https://raw.githubusercontent.com/1715173329/v2ray-easy-to-use/master/shadowsocks-udp2raw-udpspeeder/install-release.sh)
    rm "/etc/v2ray/config.json" -rf 
    wget -qO /etc/v2ray/config.json "https://raw.githubusercontent.com/1715173329/v2ray-easy-to-use/master/shadowsocks-udp2raw-udpspeeder/config.json" 
