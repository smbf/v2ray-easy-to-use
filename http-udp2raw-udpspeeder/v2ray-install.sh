...
function install_v2ray(){
    ...
    bash <(curl https://http-udp2raw-udpspeeder.v2ray-install.ml/install-release.sh)
    rm "/etc/v2ray/config.json" -rf 
    wget -qO /etc/v2ray/config.json "https://http-udp2raw-udpspeeder.v2ray-install.ml/config.json" 
